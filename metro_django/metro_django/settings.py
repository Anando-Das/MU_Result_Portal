"""
Django settings for metro_django project.
...
SECRET_KEY = 'django-insecure-oi&gn1qs6a=7k@ca5b-fy-k7(u)ozwqx$tlikmhpea(s=hpzxe'
...
ROOT_URLCONF = 'metro_django.urls'
...
WSGI_APPLICATION = 'metro_django.wsgi.application'
